var flxpxlObj = (function() {
	...
	obj.execute = function() {
		...
		var conditions_292365 = {};
		setTimeout(function() {
		function pageGroup_292365() {
			obj.placeAppNexusSegmentScript('seg?add=1467124&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_292365[queryId]=true);if(checkConditions(conditions_292365)){pageGroup_292365();}});};
		if(
			(window.location.href.indexOf('') != -1)
		) {
			if(checkConditions(conditions_292365)){pageGroup_292365();}
		}
		}, 1);

		// Page group: Organic
		var conditions_292366 = {};
		setTimeout(function() {
		function pageGroup_292366() {
			obj.placeAppNexusSegmentScript('seg?add=1467140&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_292366[queryId]=true);if(checkConditions(conditions_292366)){pageGroup_292366();}});};
		if(
			(flxKeyword != '')
		) {
			if(checkConditions(conditions_292366)){pageGroup_292366();}
		}
		}, 1);
...
function flxSendKeyword(keyword) {
	if(keyword) {
		if(!keywordsSent[keyword]) {
			sendRequest('//ib.adnxs.com/getuid?https://dm6ndb2k9edja.cloudfront.net/k.gif?pubID=317817&' + '&keyword=' + encodeURIComponent(keyword) + '&AnId=$UID' + '&url=' + encodeURIComponent(window.location.href.split('#')[0].split('?')[0].substring(0,500)) + '&ref=' + encodeURIComponent(document.referrer.substring(0, 500)));
