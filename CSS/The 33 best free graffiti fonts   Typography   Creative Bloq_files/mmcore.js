...
if(!window.mmcore){
	...
	cookie_domain:'.creativebloq.com',
	tpixel:false,
	cprefix:'mmcore.',
	inline_state:true,
...
//transport
	...
	_rt:1000,
//private
	jsver:'5.14',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
...
mmcore.CGRequest(function(){
	...
	// OPC overlapping fix
	if (/Chrome/.test(navigator.userAgent) && mmcore.OPC.mmBuildOPC && !mmcore.OPC.mmBuildOPCDef) {
		mmcore.OPC.mmBuildOPCDef = mmcore.OPC.mmBuildOPC;
		mmcore.OPC.mmBuildOPC = function() {
			mmcore.OPC.mmBuildOPCDef.apply(this, arguments);
			try {
				var opcPlaceHolder = mmcore.OPC.GetOPC().parentNode;
				opcPlaceHolder.style.zIndex = '10000';
				opcPlaceHolder.style.left = (window.innerWidth / 2 - 323) + 'px';
				opcPlaceHolder.style.top = (window.innerHeight / 2 - 249) + 'px';
				opcPlaceHolder.style.position = 'absolute';
			} catch(e) {
				mmcore.EH(e);
			}
		}
